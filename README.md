...
**ตอนนี้แปลแล้วราว 89%** ของข้อความไทยในแอป (536 จาก 601) ครอบคลุมทุกหน้าที่พนักงานกับเจ้าของร้านใช้จริง ที่เหลือ 65 รายการเกือบทั้งหมดเป็น**ชิ้นส่วนประโยค**ที่โค้ดเอาไปต่อกับชื่อสินค้าหรือตัวเลขตอนรัน (เช่น `ต้องการลบ "` + ชื่อ + `" หรือไม่?`) ซึ่งเทียบกับพจนานุกรมทั้งก้อนไม่ได้ ถ้าจะแปลต้องไปแก้โค้ดให้ประกอบประโยคทีเดียวก่อน คำไหนยังไม่ได้แปลจะขึ้นเป็นไทยตามเดิม

**สิ่งที่ไม่แปลโดยตั้งใจ:** ชื่อเมนูกับชื่อหมวด (เป็นข้อมูลของร้าน ใช้ช่องชื่อพม่าในหน้าสินค้าแทน) · ยอดเงินกับตัวเลข (ให้ตรงกับใบเสร็จและที่ลูกค้าเห็น) · ใบเสร็จลูกค้า (คนอ่านคือลูกค้ากับสรรพากร)
